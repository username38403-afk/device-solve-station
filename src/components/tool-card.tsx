...
export function ToolCard(props: ToolCardProps) {
  const { title, description, category = "Recommended", icon: Icon, tone = "lavender" } = props;
  ...
  if (props.to === "/diagnostics") return props.search ? <Link to="/diagnostics" search={props.search} className={className}>{content}</Link> : <Link to="/diagnostics" className={className}>{content}</Link>;
  if (props.to === "/tools") return props.search ? <Link to="/tools" search={props.search} className={className}>{content}</Link> : <Link to="/tools" className={className}>{content}</Link>;
  if (props.to === "/security") return props.search ? <Link to="/security" search={props.search} className={className}>{content}</Link> : <Link to="/security" className={className}>{content}</Link>;
  return props.search ? <Link to="/device" search={props.search} className={className}>{content}</Link> : <Link to="/device" className={className}>{content}</Link>;
}