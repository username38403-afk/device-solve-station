...
import { Globe, FileKey, ShieldCheck } from "lucide-react";
  ...
  return (
    <ToolWorkspace eyebrow="Privacy center" title="Your files are yours." description="A clear view of what stays in your browser and when permissions are requested.">
      <div className="grid gap-4 md:grid-cols-3">
        <WorkspacePanel title="Local by default" description="Core file tools process on this device whenever the browser can support it."><Globe className="mt-5 size-6 text-indigo" /></WorkspacePanel>
